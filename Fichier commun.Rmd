...
```{r classification}
#Voir fichier classification.r : ici je charge la base enregistrée avec la classification et je l'ajoute en var sup à disp_avignon_mono
...
disp_avignon_mono$clust <- res.HCPC$data.clust$clust
```
