...
base_class_ens <- read_delim("classification_complete_ens.csv", delim = ";", escape_double = FALSE, trim_ws = TRUE)
base <- base_class_ens %>% select("CODGEO", "clust")
base <- rename(base, clust_ens = clust)
base$CODGEO <- as.character(base$CODGEO)
base$clust_ens <- as_factor(base$clust_ens)
base$clust_ens <- fct_recode(base$clust_ens,
  "Classe 1" = "1",
  "Classe 2" = "2",
  "Classe 3" = "3")
disp_avignon <- left_join(disp_avignon, base, by = "CODGEO")
...
mf_label( topbot, 
          ...
          lines = TRUE,
          halo=FALSE)
mf_layout(title = "Classification dans l'unité urbaine d'Avignon (2018)",
    credits = "Données: INSEE, Filosofi, 2018",
    arrow = FALSE)
 mf_theme("default")
 knitr::include_graphics("images/Class_ens.png")
```
...
mf_layout(title = "Classification des familles monoparentales dans l'unité urbaine d'Avignon (2018)",
    ...
    arrow = FALSE)
 mf_theme("default")
 knitr::include_graphics("images/Class_mono.png")
```
...
mf_label( topbot, 
          ...
          lines = TRUE,
          halo=FALSE)
mf_layout(title = "Classification des parts de revenus dans l'unité urbaine d'Avignon (2018)",
    credits = "Données: INSEE, Filosofi, 2018",
    arrow = FALSE)
 mf_theme("default")
 
knitr::include_graphics("images/Classification_rev.png")
```
...
mf_label( topbot, 
          ...
          lines = TRUE,
          halo=FALSE)
mf_layout(title = "Classification des parts des revenus des familles monoparentales dans l'unité urbaine d'Avignon (2018)",
    credits = "Données: INSEE, Filosofi, 2018",
    arrow = FALSE)
 mf_theme("default")
 knitr::include_graphics("images/Classification_rev_mono.png")
```
