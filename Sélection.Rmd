...
library(questionr)
library(tidyverse)
base_class <- read_delim("Data/classification_complete.csv", 
...
class_rev <- read_delim("Data/Classification_revenus.csv", 
    delim = ";", escape_double = FALSE, trim_ws = TRUE)
...
class_rev_mono <- read_delim("Data/Classification_revenus_mono.csv", 
    delim = ";", escape_double = FALSE, trim_ws = TRUE)
...
## Réordonnancement de class_rev_mono$clust_rev_mono
class_rev_mono$clust_rev_mono <- fct_relevel(
  class_rev_mono$clust_rev_mono,
  "2", "3", "4", "1")
